...
✅ [**Crawl4AI**](https://crawl4ai.com/) - Advanced web scraping service with GPU acceleration support for both AMD64 and ARM64 architectures
...
This starter kit includes integration with Crawl4AI for advanced web scraping capabilities. The service is configured to run alongside other containers and can utilize GPU acceleration for improved performance.
...
### Using Crawl4AI in n8n Workflows

The starter kit includes a pre-configured workflow (`Marcus_Crawl4AI_Agent.json`) that demonstrates how to use Crawl4AI for web scraping tasks. To use it:

1. Import the workflow in n8n
2. Configure the HTTP Request nodes with:
